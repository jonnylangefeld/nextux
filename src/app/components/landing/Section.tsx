  ...
  return (
    <div className="h-screen bg-white dark:bg-slate-900">
      <div className="relative isolate flex h-full items-center justify-center px-6 lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-50 transition-all duration-[10000ms] ease-background-polygon dark:opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
            style={{
              clipPath: randomPolygon,
            }}
          />
